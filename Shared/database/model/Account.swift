...
public struct Account: Sendable {
    ...
    public init(uuid: UUID, name: BareJID, enabled: Bool, credentials: Credentials = .anonymous(), serverEndpoint: SocketConnectorNetwork.Endpoint? = nil, lastEndpoint: SocketConnectorNetwork.Endpoint? = nil, rosterVersion: String? = nil, statusMessage: String? = nil, push: PushSettings = .init(), additional: Additional = Additional())  {
        self.uuid = uuid;
        self.name = name;
